...
import 'package:learning_management_system_student/data/repositories/remote/remote_payment_repository.dart';
...
void setupServiceLocator() {
  ...
  getIt.registerLazySingleton<PaymentRepository>(() => RemotePaymentRepository());
